...
<html>
   ...
   <body>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12" id="content" style="background-color:#FFFFFF; border-radius: 5px; box-shadow: 10px 10px 5px grey; margin-top: 10px;">
         <h2 class="programName" ><u id="programName"></u></h2>
         ...
         <div class="programShowDiv col-lg-12 col-md-12 col-sm-12" style="overflow-y: scroll; height:200px;" id="programShowDiv"></div>
